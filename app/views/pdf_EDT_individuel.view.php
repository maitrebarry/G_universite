...
<body>
    ...
    <div id="loader" style="display: none; text-align: center; margin-bottom: 20px;">
        <img src="spinner.gif" alt="Chargement en cours..." width="50">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            loader.style.display = "block"; // Afficher le spinner au chargement
        });

        window.onload = function () {
            const loader = document.getElementById("loader");
            loader.style.display = "none"; // Masquer le spinner une fois le document prêt
        };
    </script>
</body>
</html>