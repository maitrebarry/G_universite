...
<script>
    ...
    edtActuel.addEventListener('change', () => {
        if (edtActuel.checked) {
            ...
            statusSelect.style.color = "black"; // Remet la couleur par défaut
        }
    });
    ...
    edtPasse.addEventListener('change', () => {
        if (edtPasse.checked) {
            ...
            statusSelect.style.color = "red"; // Change la couleur en rouge
        }
    });

    // Applique la couleur initiale en fonction du statut actuel
