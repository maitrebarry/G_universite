                                                        ...
                                                        <tbody>
                                                            <?php foreach ($ues as $ue): ?>
                                                                <?php if ($ue->id_parcours == $semestre->id_parcours): ?>
                                                                    ...
                                                                    <tr class='ue-item '>
                                                                        <!-- INFO UE -->
                                                                        <td class="p-1 ue-section col-4" style="min-width: 230px;">
                                                                            <div class="">
                                                            ...
                                                            <div class=" W-100 row m-auto">
                                                                ...
                                                                <div class='col-3'>
                                                                    <label class="d-block text-center">NBR
                                                                        MODULE</label>
                                                                    <input type='number'
                                                                        class='form-control nbrModule text-center' disabled
                                                                ...
                                                                <div class='col-3'>
                                                                    ...
                                                                    <input type='number' class='form-control text-center'
                                                                        disabled value="<?php echo $totalCredit ?>">
                                                                </div>
                                                                <!-- TOTAL HEURE -->
                                                                <div class='col-3'>
                                                                    <label class="d-block text-center totalHeure">T
                                                                        HEURE</label>
                                                                    <input type='number' class='form-control text-center'
                                                                        disabled value="<?php echo $totalHeure ?>">
                                                                </div>
                                                            </div>
                                                        </caption>
