                    ...
                    <div class="row">
                        ...
                        <div class="col-12 w-100  pb-1 d-flex justify-content-center align-items-center row">
                            ...
                            <div class="col-2 d-flex justify-content-center align-items-center">
                                <input type="checkbox" class="form-check" style="transform: scale(1.8);"
                                    id="s_<?php echo $semestre->id_parcours ?>" checked>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <div class="container">
                                            ...
                                            <div id="semestresTable">
                                                ...
                                                <?php foreach($semestres as $semestre): ?>
                                                <?php $nbrUe=0; $nbrModule=0; $totalCredit=0; $totalHeure=0?>
                                                <!-- SEMESTRE -->
                                                <div class='semestre'>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php $nbrUe++; $totalCredit+=$ue->ue_credit; $totalHeure+= $ue->ue_cm+$ue->ue_td+$ue->ue_tp+$ue->ue_tpe?>
                                                            <!-- UE -->
                                                            <tr class='ue-item '>
                                                                <!-- INFO UE -->
