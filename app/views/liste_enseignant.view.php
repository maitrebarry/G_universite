                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="checkbox">
                                                                    <input type="checkbox" class="checkbox-input rowCheckboxContractuels"
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item"
                                                                            ...
                                                                            <i class="fa-solid fa-calendar-plus mr-2" style="color: #7367F0; font-size: 18px;"></i>
                                                                            EDT INDIVIDUEL
                                                                        </a>
                                                                        <a class="dropdown-item"
                                                                            href="<?= ROOT ?>/Enseignants/update/<?= $enseignant->enseignant_id; ?>"
                                                                            style="font-size: 16px;">
                                                                            <i class="bx bx-edit mr-2" style="color: #17a2b8; font-size: 18px;"></i>
                                                                            Modifier
                                                                        </a>
                                                                        <a class="dropdown-item"
                                                                            href="<?= ROOT ?>/Enseignants/delete/<?= $enseignant->enseignant_id; ?>"
                                                                            style="font-size: 16px;">
                                                                            <i class="bx bx-trash mr-2" style="color: #dc3545; font-size: 18px;"></i>
                                                                            Supprimer
                                                                        </a>
                                                                        <a class="dropdown-item"
                ...
                printButton.addEventListener("click", function () {
                    ...
                    checkboxes.forEach(checkbox => {
                        if (checkbox.checked) {
                            ...
                            selectedTeachers.push({ id: teacherId, name: teacherName });
                        }
                    });
                    ...
                    if (selectedTeachers.length > 0) {
                        ...
                        selectedTeachers.forEach(teacher => {
                            ...
                            setTimeout(() => {
                                imprimerEdt(teacher.id, "EDT_" + teacher.name.replace(/\s+/g, "_"));
                            }, 500);
                        });
                    } else {
